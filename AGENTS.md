...
- `adding-translations` — Adds new translations to the application. Activates when modifying language files (e.g., `lang/es.json`) or when user mentions adding translations, updating language files, or working with localization.
