...
export enum TenantPermission {
  ...
  CALENDAR_EVENTS_MANAGE = 'calendar_events.manage',
  CALENDAR_EVENTS_CREATE = 'calendar_events.create',
  CALENDAR_EVENTS_UPDATE = 'calendar_events.update',
  CALENDAR_EVENTS_DELETE = 'calendar_events.delete',
  CALENDAR_EVENTS_EXPORT = 'calendar_events.export',
  CALENDAR_EVENTS_EMAIL = 'calendar_events.email',
