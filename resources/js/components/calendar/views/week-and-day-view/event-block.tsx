...
export function EventBlock({ event, className }: IProps) {
  ...
  const calendarWeekEventCardClasses = cn(calendarWeekEventCardVariants({ color, className }), durationInMinutes < 35 && 'justify-center py-0');
        ...
        <EventDetailsDialog event={event}>
          <button type="button" className={calendarWeekEventCardClasses} style={{ height: `${heightInPixels}px` }}>
            <div className="flex items-center gap-1.5 truncate">
              {badgeVariant === 'dot' && (
                <svg width="8" height="8" viewBox="0 0 8 8" xmlns="http://www.w3.org/2000/svg" className="shrink-0" aria-hidden="true">
