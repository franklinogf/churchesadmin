...
it('implements wallet interfaces', function (): void {
    ...
    expect($wallet)->toBeInstanceOf(Bavix\Wallet\Interfaces\Confirmable::class);
    expect($wallet)->toBeInstanceOf(Bavix\Wallet\Interfaces\Wallet::class);
    expect($wallet)->toBeInstanceOf(Bavix\Wallet\Interfaces\WalletFloat::class);
});
...
it('has initial transaction relationship', function (): void {
    ...
    expect($wallet->initialTransaction())->toBeInstanceOf(Illuminate\Database\Eloquent\Relations\MorphOne::class);
});
