...
describe('ArrayFallback class', function () {
    it('returns the value from the array when the key exists', function () {
    ...
    it('returns the fallback value when the key does not exist', function () {
        $data = ['name' => 'John', 'email' => 'john@example.com'];
    ...
    it('returns the value from the array even when it is null', function () {
    ...
    it('returns the value from the array even when it is an empty string', function () {
    ...
    it('handles nested arrays with dot notation', function () {
